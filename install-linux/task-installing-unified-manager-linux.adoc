...
| `grep p7zip` 
|===
. 설치된 MySQL 버전이 MySQL 8.0.21 Community Edition보다 이전 버전인 경우 다음 명령을 입력하여 설치 제거하십시오.``rpm -e <mysql_package_name>``
+
...
웹 UI에 액세스하여 umadmin 사용자의 기본 암호를 변경하고 에 설명된 대로 Unified Manager의 초기 설정을 수행합니다 link:../config/concept-configuring-unified-manager.html["Active IQ Unified Manager 구성"].
