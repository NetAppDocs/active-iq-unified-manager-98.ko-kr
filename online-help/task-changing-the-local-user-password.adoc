...
유지보수 사용자 및 원격 사용자의 암호는 다음 단계를 사용하여 변경할 수 없습니다. 원격 사용자 암호를 변경하려면 암호 관리자에게 문의하십시오. 유지보수 사용자 암호를 변경하려면 의 ""유지보수 콘솔 사용" 장을 참조하십시오 link:../config/concept-configuring-unified-manager.html["Active IQ Unified Manager 구성"].
